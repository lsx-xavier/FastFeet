# FastFeet
> Projeto para aprendizado de node.js com a RocketSeat

Projeto focado para cadastro de Recipients (Destinatários) de uma transportadora fictícia, esta parte é o começo do projeto que tem que ser entregue no final do curso.

## Histórico de lançamentos

* 1
    * Starting project: Start with configuration of NODE.JS and connection with date base
* 2
    * Starting business rule: Start all the project.
* 2
    * Finishing for now: Finish code the business rule and validation.
...
## Sobre o projeto pela RocketSeat
